# Strategic Hygiene Checklist

This checklist adapts the Bayesian skill's prior-hygiene idea to strategic interaction.

## Purpose

Before giving a recommendation, check whether the model is anchored by strategic facts rather than theory names.

## Core Checks

- player hygiene: no important actor is missing
- action hygiene: each listed strategy is feasible and observable
...
- safety hygiene: legal, regulatory, antitrust, or coercive tactics are flagged
